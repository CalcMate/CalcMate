...
window.SM_DYNAMIC_FAQ = [{"priority": 1, "condition": "outputs.total_benefit === 0 && (outputs.notices||[]).length > 0", "q": "피보험단위기간 6개월 미만이라 실업급여를 받을 수 없나요?", "a": "고용보험법 제40조에 따라 이직 전 18개월 이내에 피보험단위기간이 합산 180일(약 6개월) 이상이어야 구직급여를 수급할 수 있습니다. 복수의 직장에서 근무한 기간을 합산할 수 있습니다."}, {"priority": 2, "condition": "(outputs.notices||[]).some(function(n){return n.indexOf('상한')>=0 || n.indexOf('하한')>=0;})", "q": "구직급여 상한액/하한액이 적용됐는데 왜 그런가요?", "a": "구직급여는 1일 상한액(66,000원)과 하한액(최저임금의 80%)이 법으로 정해져 있습니다(고용보험법 제46조). 실제 임금과 무관하게 이 범위 내에서 지급됩니다."}, {"priority": 3, "condition": "outputs.total_benefit > 0", "q": "실업급여는 언제부터 받을 수 있나요?", "a": "퇴직 후 고용센터에 수급자격 신청(워크넷 구직 등록 후)을 하면 약 7~14일의 처리 기간 이후 지급이 시작됩니다. 자발적 퇴사는 원칙적으로 실업급여 수급이 불가합니다."}];
