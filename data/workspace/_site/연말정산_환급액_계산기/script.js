...
window.computeResult = function(inputs){
  ...
  var CREDIT_BASE_HIGH=715000;
  var LD_TBL=[{lim:5000000,rate:0.7,base:0,prev:0},{lim:15000000,rate:0.4,base:3500000,prev:5000000},{lim:45000000,rate:0.15,base:7500000,prev:15000000},{lim:100000000,rate:0.05,base:12000000,prev:45000000},{lim:Infinity,rate:0.02,base:14750000,prev:100000000}];
  ...
  var TAX_TBL=[{lim:14000000,rate:0.06,ded:0},{lim:50000000,rate:0.15,ded:1260000},{lim:88000000,rate:0.24,ded:5760000},{lim:150000000,rate:0.35,ded:15440000},{lim:300000000,rate:0.38,ded:19940000},{lim:500000000,rate:0.4,ded:25940000},{lim:1000000000,rate:0.42,ded:35940000},{lim:Infinity,rate:0.45,ded:65940000}];
  ...
  var TCL_TBL=[{sm:33000000,fx:740000,rr:null,ba:null,rf:null,fl:null},{sm:70000000,fx:null,rr:0.008,ba:740000,rf:33000000,fl:660000},{sm:120000000,fx:null,rr:0.5,ba:660000,rf:70000000,fl:500000},{sm:Infinity,fx:null,rr:0.5,ba:500000,rf:120000000,fl:200000}];
  ...
  out._formula = "총급여 "+gross.toLocaleString()+"원 → 과세표준 "+Math.round(taxable).toLocaleString()+"원 → 산출세액 "+gross_tax.toLocaleString()+"원 → 결정세액 "+determined.toLocaleString()+"원 → "+(refund>=0?"환급 "+refund.toLocaleString()+"원":"추가납부 "+(-refund).toLocaleString()+"원");
  return out;
};
