...
window.SM_CTA_RULES = {"default": {"text": "4대보험 더 알아보기", "links": [{"label": "4대보험 요율 가이드", "href": "/blog/four-insurance-rates-2025/"}, {"label": "전체 계산기", "href": "/"}], "analytics": "cta_fi_default"}, "rules": [{"condition": "outputs.total > 0", "text": "4대보험료를 계산했습니다", "links": [{"label": "연말정산도 계산해 보기", "href": "../연말정산_환급액_계산기/"}, {"label": "4대보험 가이드", "href": "/blog/four-insurance-rates-2025/"}], "analytics": "cta_fi_result"}]};
window.SM_DYNAMIC_FAQ = [{"priority": 2, "condition": "(outputs.notices||[]).some(function(n){return n.indexOf('상한')>=0 || n.indexOf('하한')>=0;})", "q": "국민연금 기준소득월액 상한/하한이 적용됐는데 왜 그런가요?", "a": "국민연금은 기준소득월액에 상한(6,170,000원)과 하한(390,000원)이 있습니다(국민연금법 제88조). 실제 월급과 무관하게 이 범위 내에서 보험료가 산정됩니다."}, {"priority": 3, "condition": "outputs.total > 0", "q": "사업주가 부담하는 4대보험료는 얼마인가요?", "a": "사업주는 근로자와 동일하게 국민연금·건강보험·고용보험을 분담합니다. 산재보험은 사업주가 100% 부담하며 근로자 공제 없습니다."}];
