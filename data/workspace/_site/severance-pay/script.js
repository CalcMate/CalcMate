...
window.SM_CTA_RULES = {"default": {"text": "퇴직 관련 계산기", "links": [{"label": "실업급여도 계산해 보기", "href": "../unemployment-benefit/"}, {"label": "전체 계산기", "href": "/"}], "analytics": "cta_sp_default"}, "rules": [{"condition": "outputs.severance_pay > 0", "text": "퇴직금을 받을 수 있습니다", "links": [{"label": "실업급여도 신청해 보세요", "href": "../unemployment-benefit/"}, {"label": "4대보험 확인하기", "href": "../four-insurances/"}], "analytics": "cta_sp_eligible"}, {"condition": "outputs.severance_pay === 0", "text": "1년 이상 근무 시 퇴직금이 발생합니다", "links": [{"label": "퇴직금 계산법 가이드", "href": "/blog/severance-pay-guide/"}, {"label": "전체 계산기", "href": "/"}], "analytics": "cta_sp_ineligible"}]};
window.SM_DYNAMIC_FAQ = [{"priority": 1, "condition": "outputs.severance_pay === 0 && (outputs.notices||[]).length > 0", "q": "1년 미만 근무라서 퇴직금이 0원인 이유는?", "a": "근로자퇴직급여보장법 제8조에 따라 계속근로기간이 1년 미만인 경우 퇴직금 지급 의무가 없습니다. 1년 이상 근무 후 퇴직 시 퇴직금이 발생합니다."}, {"priority": 3, "condition": "outputs.severance_pay > 0", "q": "퇴직금 수령 후 실업급여도 받을 수 있나요?", "a": "퇴직금과 실업급여는 별개입니다. 퇴직금을 수령한 후에도 고용보험 수급 자격을 충족하면 실업급여를 신청할 수 있습니다."}];
