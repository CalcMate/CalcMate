...
window.SM_CTA_RULES = {"default": {"text": "연차수당 더 알아보기", "links": [{"label": "연차수당 가이드", "href": "/blog/annual-leave-allowance-guide/"}, {"label": "전체 계산기", "href": "/"}], "analytics": "cta_al_default"}, "rules": [{"condition": "outputs.annual_leave_allowance > 0", "text": "연차수당을 계산했습니다", "links": [{"label": "연차수당 가이드", "href": "/blog/annual-leave-allowance-guide/"}, {"label": "주휴수당도 확인하기", "href": "../weekly-holiday-allowance/"}], "analytics": "cta_al_result"}]};
window.SM_DYNAMIC_FAQ = [{"priority": 2, "condition": "inputs.unused_days > 25", "q": "미사용 연차가 25일을 초과한 경우 수당은 어떻게 계산하나요?", "a": "근로기준법 제60조 제4항에 따라 법정 연차는 최대 25일까지 인정됩니다. 25일 초과분은 취업규칙이나 단체협약에 따른 약정 연차이므로 별도 규정을 확인하세요."}, {"priority": 3, "condition": "outputs.annual_leave_allowance > 0", "q": "연차수당을 받을 때 세금이 공제되나요?", "a": "연차수당은 근로소득에 해당하므로 소득세와 4대보험이 공제됩니다. 실수령액은 세후 금액으로 계산하세요."}];
